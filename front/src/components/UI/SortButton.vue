<template>
  <div class="sort-layout">
	...
	<label class="sort-contatiner">
	  <input id="sort-input" type="checkbox" checked="checked">
		...
		<defs>
			...
			<g id="day">
				...
				<g id="day-content">
					...
					<g id="land">
						<path d="M49.07,13.32c-1.07,1.19-.55,2.29-1.42,2.92s-2.08-.19-2.58.42c-.19.22-.3.66.66,2.91s1.53,3.57,2.25,3.66c.94.12,1.08-1.24,3.08-2.24,1.53-.77,2.55-.53,2.92-1.34.22-.47,0-1-.33-2a26.68,26.68,0,0,0-1.5-2.83c-.79-1.6-.78-2.26-1.34-2.41C50.06,12.21,49.2,13.17,49.07,13.32Z" style="fill: #2c962e"/>
						<path d="M57.81,12.74c-1.15-.08-2.54.74-2.58,1.75a2.12,2.12,0,0,0,1.41,1.75,4.82,4.82,0,0,0,2.34.08h0s.77,1.42,1.16,1.33.49-1.18.25-2.16S59.34,12.85,57.81,12.74Z" style="fill: #2c962e"/>
						<path d="M58.06,19.57c-.91.9-1.58,1.55-1.42,2.08.24.77,2.24,1.31,3.25.42s.5-3.36-.25-3.58C59.27,18.38,58.85,18.79,58.06,19.57Z" style="fill: #2c962e"/>
						<path d="M66.89,13.32c-1.07,1.19-.55,2.29-1.42,2.92s-2.07-.19-2.58.42c-.19.22-.3.66.67,2.91s1.52,3.57,2.25,3.66c.93.12,1.07-1.24,3.08-2.24,1.52-.77,2.55-.53,2.91-1.34.22-.47,0-1-.33-2A26.68,26.68,0,0,0,70,14.82c-.78-1.6-.77-2.26-1.33-2.41C67.89,12.21,67,13.17,66.89,13.32Z" style="fill: #2c962e"/>
						<path d="M75.63,12.74c-1.15-.08-2.54.74-2.58,1.75a2.12,2.12,0,0,0,1.42,1.75,4.79,4.79,0,0,0,2.33.08h0s.77,1.42,1.16,1.33.49-1.18.25-2.16S77.16,12.85,75.63,12.74Z" style="fill: #2c962e"/>
						<path d="M75.88,19.57c-.91.9-1.58,1.55-1.41,2.08.23.77,2.23,1.31,3.24.42s.5-3.36-.24-3.58C77.09,18.38,76.68,18.79,75.88,19.57Z" style="fill: #2c962e"/>
					</g>
						</g>
					<g class="clouds">
				...
				<g id="balloon" transform="translate(-1 -2)">
					<path d="M30,18.46C30,24,25.52,32.09,20,32.09S10,24,10,18.46a10,10,0,1,1,20,0Z" style="fill: #004373"/>
					<polygon transform="translate(10 9)" points="9.39 23.36 8.59 24.57 10.9 24.57 10.48 23.14 9.39 23.36" style="fill: #004373"/>
					<path id="string-bend" d="M19.84,31.6c0,2,.66,3.24.66,6.4,0,2.91-.29,2.33-3.24,4.93" style="fill: none;stroke: #313a3f;stroke-miterlimit: 10;stroke-width: 0.5px"/>
					
    			</g>
    
			</g>
			<g id="night">
				<rect  id="night-back" width="60" height="34" style="fill: #004373"/>
				...
				<circle cx="41" cy="17" r="10" style="fill: #3366ff; filter:url(#glow)"/>
			</g>
			<clipPath id="switch" >
				<circle id="circle" cx="19" cy="17" r="10"/>
			</clipPath>
			
			<path id="string-straight" d="M19.84,31.6c0,2.21-.17,3.38-.17,7.63,0,2.39,1.33,3.7,3.24,3.7" style="fill: none;stroke: #313a3f;stroke-miterlimit: 10;stroke-width: 0.5px"/>
		</defs>

		<g clip-path="url(#sort-contatiner)">
...
let switchToggle = document.getElementById('sort-input');
